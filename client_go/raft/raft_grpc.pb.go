...
const (
	...
	RaftService_ReceiveCommand_FullMethodName = "/raft.RaftService/ReceiveCommand"
	RaftService_ReadData_FullMethodName       = "/raft.RaftService/ReadData"
)
...
type RaftServiceClient interface {
	...
	ReceiveCommand(ctx context.Context, in *CommandRequest, opts ...grpc.CallOption) (*CommandReply, error)
	ReadData(ctx context.Context, in *ReadRequest, opts ...grpc.CallOption) (*ReadReply, error)
}
...
func (c *raftServiceClient) ReceiveCommand(ctx context.Context, in *CommandRequest, opts ...grpc.CallOption) (*CommandReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CommandReply)
	err := c.cc.Invoke(ctx, RaftService_ReceiveCommand_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *raftServiceClient) ReadData(ctx context.Context, in *ReadRequest, opts ...grpc.CallOption) (*ReadReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReadReply)
	err := c.cc.Invoke(ctx, RaftService_ReadData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RaftServiceServer interface {
	...
	ReceiveCommand(context.Context, *CommandRequest) (*CommandReply, error)
	ReadData(context.Context, *ReadRequest) (*ReadReply, error)
...
func (UnimplementedRaftServiceServer) ReceiveCommand(context.Context, *CommandRequest) (*CommandReply, error) {
	return nil, status.Error(codes.Unimplemented, "method ReceiveCommand not implemented")
}
func (UnimplementedRaftServiceServer) ReadData(context.Context, *ReadRequest) (*ReadReply, error) {
...
func _RaftService_ReceiveCommand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CommandRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RaftServiceServer).ReceiveCommand(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RaftService_ReceiveCommand_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftServiceServer).ReceiveCommand(ctx, req.(*CommandRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _RaftService_ReadData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReadRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RaftServiceServer).ReadData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RaftService_ReadData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftServiceServer).ReadData(ctx, req.(*ReadRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RaftService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RaftService_ReceiveCommand_Handler,
		},
		{
			MethodName: "ReadData",
			Handler:    _RaftService_ReadData_Handler,
		},
	},
